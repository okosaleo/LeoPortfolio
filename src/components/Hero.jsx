...
export default function Hero() {
  ...
  return (
    <div className='bg-[#0F0F0F] w-full md:h-[93vh] h-[73vh] flex flex-col items-center'>
      <div className=" flex items-center relative justify-evenly">
        <div className=" md:w-1/3 w-70vh lg:max-lg:w-[70vh] ">
        <Lottie animationData={kimetsu}/>
        </div>
        <div className=" z-10 absolute md:mt-0 ">
         <h1 className=" font-Sunage  md:text-[7rem] lg:max-lg:text-[2rem] text-[1.8rem] text-[#fbfbfb]">Lenny The Dev</h1>
         </div>
      </div>
